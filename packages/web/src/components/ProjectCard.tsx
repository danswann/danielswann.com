...
export default function ProjectCard(props: ProjectCardProps) {
  ...
  return(
    <Card sx={{ padding:'1rem 2rem 0.5rem 2rem' }}>
      <Box  sx={{ display:'flex', flexDirection:'row', justifyContent:'flex-start', marginBottom:'1rem', [theme.breakpoints.down('md')]:{flexDirection:'column'} }}>
        ...
        <CardContent sx={{ flex:3, margin:'0 0.5rem', [theme.breakpoints.down('md')]:{margin:0} }}>
          {props.blurb}
        </CardContent>
      </Box>
      {
